...
jQuery(document).ready(function () {
         JSON2=$.getJSON("quiz.json", function( data ) {
                ...
                for (var i = 0; i<JSON2.questions.length; i++){
                        ...
                        flickrJSON=$.getJSON("https://api.flickr.com/services/rest/?\u0026method=flickr.photos.search\u0026api_key=929b35554adaeba34d52745f880a6a66\u0026sort=relevance\u0026format=json\u0026per_page=1\u0026tags=supreme,court"/*+JSON2.questions[i].tag*/, function(data){
